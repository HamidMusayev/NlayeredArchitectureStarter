...
namespace DAL.Migrations
{
    ...
    [Migration("20260531090703_RemoveRefreshTokenPlaintext")]
    partial class RemoveRefreshTokenPlaintext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ENTITIES.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b30bc843-1d40-416e-9107-32e88988e68e"),
                        ...
                        new
                        {
                            Id = new Guid("d0630de8-59a0-40cd-801b-e2f889a010ed"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "Admin",
                            Name = "İnzibatçı"
                        ...
                        new
                        {
                            Id = new Guid("82ced5c0-a496-419b-9697-8b3bf3306515"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "User",
                            Name = "İstifadəçi"
                        ...
                        new
                        {
                            Id = new Guid("eee9f4dc-f5dc-492a-b741-ad246f630c29"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "Guest",
                            Name = "Qonaq"
            ...
            modelBuilder.Entity("ENTITIES.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e8a8492-7284-433c-8332-4fe02b3e2c5c"),
                            ContactNumber = "",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "test@test.tst",
                            IsDeleted = false,
                            Password = "Fag1UtnjsK8nWbXw0TYcL1cXyvLajju5c7/RcBbT+X+s4s+GiPyA7PsXtVH3vIUnlXOVHtss2wrOPyH0J2ycxg==",
                            Salt = "5DHTEo4x6ybRXTXYcqiIjA==",
                            Username = "Test"
                        });
                });
